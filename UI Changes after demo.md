...
### HIL Mode:
	...
	c. Show Approve / Reject button on every item.
	d. Show Rejected Items at the top.
### Quantity Adjustment modals:
	a. When user clicks on '+' , '-' button in the shown products, we are going to show a Quantity Adjustment Pop up.
	b. Here user will adjust the quantity of the product and on user actions event the confirmation button will be enabled.
	c. The stack of video will be sent with their tags and events.
### Enhancements:
	a. Adding loaders for app while loading videos or getting events.
